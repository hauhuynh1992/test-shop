...
open class ShopHopAppBaseActivity : AppCompatActivity() {
    ...
    fun setToolbar(mToolbar: Toolbar) {
        ...
        mToolbar.setNavigationIcon(R.drawable.shophop_ic_keyboard_backspace)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (progressDialog == null) {
            ...
            progressDialog!!.setContentView(R.layout.shophop_custom_dialog)
        }
    }
...
//            mAdView!!.adUnitId = getString(R.string.sh_banner_id)
//

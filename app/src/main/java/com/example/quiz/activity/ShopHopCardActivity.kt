...
import kotlinx.android.synthetic.main.shophop_activity_card.*
...
class ShopHopCardActivity : ShopHopAppBaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.shophop_activity_card)
        title = getString(R.string.sh_lbl_add_card)
        setToolbar(toolbar)
        ...
        mYearAdapter = ArrayAdapter(this, R.layout.shophop_spinner_items, mYearList)
        mMonthAdapter = ArrayAdapter(this, R.layout.shophop_spinner_items, mMonthList)
        ...
        btnSubmit.onClick {
            snackBar(context.getString(R.string.sh_msg_success_card))
            finish()
        }

...
import kotlinx.android.synthetic.main.shophop_layout_itemimage.view.*
import com.example.quiz.utils.extensions.loadImageFromUrl


class ShopHopProductImageAdapter(private var mImg: ArrayList<String>) : PagerAdapter() {

    override fun instantiateItem(parent: ViewGroup, position: Int): Any {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.shophop_layout_itemimage, parent, false).apply {

...
import com.example.quiz.utils.extensions.hide
import com.example.quiz.utils.extensions.show
...
class ExpandableTextView : FrameLayout {
    ...
    private fun init(attrs: AttributeSet?) {
        mMainLayout = View.inflate(context, R.layout.shophop_expandable_text_view_layout, this)
        ...
        if (attrs != null) {
            ...
            try {
                ...
                if (isDefaultExpand) {
                    ...
                    moreLess!!.text = resources.getString(R.string.sh_more)
                } else {
                    content!!.maxLines = maxLine
                    moreLess!!.text = resources.getString(R.string.sh_less)
                }
    ...
    fun toggle() {
        if (moreLess!!.text == resources.getString(R.string.sh_more)) {
            toggle(true)
        } else {
            toggle(false)
        }
    ...
    private fun toggle(expand: Boolean) {
        if (expand) {
            expand()
            moreLess!!.text = resources.getString(R.string.sh_less)
            moreLess!!.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.shophop_ic_arrow_up,0)
            return
        }
        collapse()
        moreLess!!.text = resources.getString(R.string.sh_more)
        moreLess!!.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.shophop_ic_arrow_down,0)

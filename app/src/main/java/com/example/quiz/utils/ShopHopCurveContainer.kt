...
import developer.shivam.crescento.ShopHopPathProvider


class ShopHopCurveContainer : RelativeLayout {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        mClipPath = ShopHopPathProvider.getClipPath(width, height, curvatureHeight, 0)
    ...
    override fun getOutlineProvider(): ViewOutlineProvider {
        return object : ViewOutlineProvider() {
            override fun getOutline(view: View, outline: Outline) {
                try {
                    outline.setConvexPath(ShopHopPathProvider.getOutlinePath(width, height, curvatureHeight, 0, 0))
                } catch (e: Exception) {
                    Log.d("Outline Path", e.message.toString())
                }

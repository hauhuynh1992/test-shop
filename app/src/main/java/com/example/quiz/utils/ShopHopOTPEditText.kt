...
import com.example.quiz.utils.extensions.hideSoftKeyboard

class ShopHopOTPEditText(val mEditTextList: Array<EditText?>, val context: FragmentActivity, val transaparant:Drawable, val dot:Drawable) {
    init {

package com.example.quiz.utils.dotsindicator
...
import com.example.quiz.utils.extensions.tint
...
class DotsIndicator(context: Context, attrs: AttributeSet? = null) : LinearLayout(context, attrs) {
    ...
    init {
        ...
        try {
            ...
            this.animatorResId = ta.getResourceId(R.styleable.DotsIndicator_dots_animator, R.anim.shophop_scale_with_alpha)
            this.animatorReverseResId = ta.getResourceId(R.styleable.DotsIndicator_dots_animator_reverse, 0)
            this.backgroundResId = ta.getResourceId(R.styleable.DotsIndicator_dot_drawable, R.drawable.shophop_bg_black_dot)
        ...
        indicatorBackgroundResId = if (this.backgroundResId == 0) R.drawable.shophop_bg_black_dot else this.backgroundResId

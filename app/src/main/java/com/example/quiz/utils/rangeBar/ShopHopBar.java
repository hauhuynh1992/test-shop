...
public class ShopHopBar {
     ...
     */
    public float getNearestTickCoordinate(ShopHopPinView thumb) {
     ...
     */
    public int getNearestTickIndex(ShopHopPinView thumb) {
     ...
     *               View#onDraw()}
     */
    public void drawTicks(Canvas canvas, float pinRadius, ShopHopPinView rightThumb) {
        drawTicks(canvas, pinRadius, rightThumb, null);
    }

    public void drawTicks(Canvas canvas, float pinRadius, ShopHopPinView rightThumb, @Nullable ShopHopPinView leftThumb) {
    ...
    private void drawTickLabel(Canvas canvas, final String label, float x, float pinRadius,
                               boolean first, boolean last, boolean isTop, ShopHopPinView rightThumb, @Nullable ShopHopPinView leftThumb) {

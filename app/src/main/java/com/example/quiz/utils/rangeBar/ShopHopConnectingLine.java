 ...
 */
public class ShopHopConnectingLine {
     ...
     */
    public ShopHopConnectingLine(float y, float connectingLineWeight,
     ...
     */
    public void draw(Canvas canvas, ShopHopPinView leftThumb, ShopHopPinView rightThumb) {
     ...
     */
    public void draw(Canvas canvas, float leftMargin, ShopHopPinView rightThumb) {
        paint.setShader(getLinearGradient(0, canvas.getWidth(), mY));

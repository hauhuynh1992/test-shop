...
class ShopHopPinView extends View {
    ...
    private ShopHopIRangeBarFormatter formatter;

    private float mMinPinFont = ShopHopRangeBar.DEFAULT_MIN_PIN_FONT_SP;

    private float mMaxPinFont = ShopHopRangeBar.DEFAULT_MAX_PIN_FONT_SP;
    ...
    public ShopHopPinView(Context context) {
        super(context);
    }

    public void setFormatter(ShopHopIRangeBarFormatter mFormatter) {
    ...
    public void init(Context ctx, float y, float pinRadiusDP, int pinColor, int textColor,
        ...
        mPin = ContextCompat.getDrawable(ctx, R.drawable.shophop_rotate);
